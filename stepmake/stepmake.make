...
include $(depth)/stepmake/toplevel-version.make
...
ifeq ($(BUILTINS_REMOVED),)
  ...
  include $(stepmake)/no-builtin-rules.make
endif
.SUFFIXES:
...
-include $(addprefix $(stepmake)/,$(addsuffix -inclusions.make, $(STEPMAKE_TEMPLATES)))

include $(addprefix $(stepmake)/,$(addsuffix -vars.make, $(STEPMAKE_TEMPLATES)))
include $(addprefix $(stepmake)/,$(addsuffix -rules.make, $(STEPMAKE_TEMPLATES)))
include $(addprefix $(stepmake)/,$(addsuffix -targets.make, $(STEPMAKE_TEMPLATES)))
